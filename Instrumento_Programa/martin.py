...
class Ui_MainWindow(object):
    ...
    def sql_table_view_model(self):
            ...
            self.model.setHeaderData(1, QtCore.Qt.Horizontal, "cod_Curso")
            self.model.setHeaderData(2, QtCore.Qt.Horizontal, "cod_Materia")
            self.model.setHeaderData(3, QtCore.Qt.Horizontal, "anio")
            self.model.setHeaderData(4, QtCore.Qt.Horizontal, "p1")        
            self.model.setHeaderData(5, QtCore.Qt.Horizontal, "p2")
            self.model.setHeaderData(6, QtCore.Qt.Horizontal, "p3")                          
            self.model.setHeaderData(7, QtCore.Qt.Horizontal, "p4")
            self.model.setHeaderData(8, QtCore.Qt.Horizontal, "promedio")  
            self.model.setHeaderData(9, QtCore.Qt.Horizontal, "recuperacion1")  
            self.model.setHeaderData(10, QtCore.Qt.Horizontal, "recuperacion2")
        
    def print_data(self):
            sqlite_file='Curso.db'
    ...
    def create_DB(self):
            ...
            query.exec_("create table curso(ID int primary key,"
                            "cod_Curso INT, cod_Materia INT, anio INT, p1 INT, p2 INT, p3 INT, p4 INT, promedio INT, recuperacion1 INT, recuperacion2 INT)")
            query.exec_("insert into curso values(1, '0000', '1010', '2015', '9' , '9', '9' , '9', '9', '9', '9')")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Curso"))
